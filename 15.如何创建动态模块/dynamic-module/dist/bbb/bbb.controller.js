...
let BbbController = class BbbController {
    constructor(bbbService, confingOptions) {
        this.bbbService = bbbService;
        this.confingOptions = confingOptions;
    }
    create(createBbbDto) {
        return this.bbbService.create(createBbbDto);
    }
    findAll() {
        console.log('confingOptions', this.confingOptions);
...
exports.BbbController = BbbController = __decorate([
    ...
    __metadata("design:paramtypes", [bbb_service_1.BbbService, Object])
], BbbController);
